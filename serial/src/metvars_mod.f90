...
!-------------------------------------------------------------------------------
  ...
  REAL,          ALLOCATABLE   :: fch        ( : , : )
  REAL,          ALLOCATABLE   :: frt        ( : , : )
  REAL,          ALLOCATABLE   :: clu        ( : , : )
  REAL,          ALLOCATABLE   :: popu       ( : , : )
  REAL,          ALLOCATABLE   :: laie       ( : , : )
  REAL,          ALLOCATABLE   :: c1r        ( : , : )
  REAL,          ALLOCATABLE   :: c2r        ( : , : )
  REAL,          ALLOCATABLE   :: c3r        ( : , : )
  REAL,          ALLOCATABLE   :: c4r        ( : , : )
